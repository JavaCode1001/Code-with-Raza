...
import com.soft.infg.booking.entity.Passenger;
import com.soft.infg.booking.repository.BookingRepository;
import com.soft.infg.booking.repository.InventoryRepository;
...
public class BookingServiceApplication implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		Inventory[] invs = { new Inventory("BF100", "22-JAN-16", 100), new Inventory("BF101", "22-JAN-16", 100),
				new Inventory("BF102", "22-JAN-16", 100), new Inventory("BF103", "22-JAN-16", 100),
				new Inventory("BF104", "22-JAN-16", 100), new Inventory("BF105", "22-JAN-16", 100),
